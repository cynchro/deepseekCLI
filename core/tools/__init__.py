...
from core.tools import fs, search, search_code, shell, build, tasks, subagent, explore, browser, plan
from core.tools.base import ToolContext  # noqa: F401 (re-export)

_REGISTRY = {}
for _mod in (fs, search, search_code, shell, build, tasks, subagent, explore, browser, plan):
